...
class ENItem {
    ...
    @SuppressWarnings("unchecked")
    private Map getItemMapByName(String name, String bucket)
            throws EchoNestException {
        return getItemMap(name, bucket, "name");
    }

    @SuppressWarnings("unchecked")
    private Map getItemMap(String id, String bucket, String idType)
            throws EchoNestException {
        Params p = new Params();
        p.add(idType, id);
    ...
    @SuppressWarnings("unchecked")
    private Map getItemMap(String id, List<String> buckets)
            throws EchoNestException {
        Params p = new Params();
        p.add("id", id);
