...
public class SongCatalogTests extends TestCase {
    ...
    private SongCatalog createHotCatalogByForeignIDs(int size, String title, String idspace)
            throws EchoNestException {
        deleteCatalogByName(title);
        SongCatalog catalog = en.createSongCatalog(title);
        CatalogUpdater updater = new CatalogUpdater();
    ...
    public void readCatalogTest() throws EchoNestException {
        ...
        assertTrue("song id resolution count is zero. mismatch " + mismatchCount + " of " + size, mismatchCount == 0);
    }
    ...
    public void createSmallCatalog() throws EchoNestException {
        ...
        String[] songNames = {"bad romance", "my name is jonas", "heartbreaker", "blackbird", "colma", "siberian khartru",
